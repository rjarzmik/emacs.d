...
Must be one of \"JavaDoc\", \"Qt\" or \"C++\" or \"Kernel\". Setting this variable
to anything else will generate errors."
  :type '(radio (const :tag "JavaDoc" "JavaDoc")
		(const :tag "Qt" "Qt")
		(const :tag "C++" "C++")
		(const :tag "Kernel" "Kernel"))
  :group 'doxymacs)
...
(defconst doxymacs-Kernel-blank-multiline-comment-template
 '("/**" > n "* " p > n "* " > n "*/" > n)
 "Default Kernel-style template for a blank multiline doxygen comment.")
...
(defconst doxymacs-Kernel-blank-singleline-comment-template
 '("/// " > p)
 "Default Kernel-style template for a blank single line doxygen comment.")
...
(defun doxymacs-doxygen-command-char ()
  (cond
   ...
   ((string= doxymacs-doxygen-style "Kernel") "@")
   (t "@")))
...
(defconst doxymacs-Kernel-file-comment-template
 '("/**" > n
   " * " (doxymacs-doxygen-command-char) "file   "
   (if (buffer-file-name)
       (file-name-nondirectory (buffer-file-name))
   ...
   " * " p > n
   " */" > n)
 "Default Kernel-style template for file documentation.")
...
(defconst doxymacs-JavaDoc-function-comment-template
 '((let ((next-func (doxymacs-find-next-func)))
	 ...
	 (list
	  'l
	  "/** " '> 'n
	  " * @brief Function short description" 'p '> 'n
	  " *   <Function long description>" '> 'n
...
(defconst doxymacs-Kernel-function-comment-template
 '((let ((next-func (doxymacs-find-next-func)))
     (if next-func
	 (list
	  'l
	  "/**" 'n
	  " * " (cdr (assoc 'func next-func)) " - short description"
	  'p '> 'n
	  (doxymacs-parm-tempo-element (cdr (assoc 'args next-func)))
	  " *" 'n
	  " * <Function long description>" '> 'n
...
style."
  (error (concat
	  ...
	  doxymacs-doxygen-style
	  ": must be one of \"JavaDoc\", \"Qt\" or \"C++\" or \"Kernel\".")))
